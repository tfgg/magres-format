...
parser.add_argument('atom_species1', nargs='?', type=str, default=None,
                    help='Only print couplings from this atomic species.')
parser.add_argument('atom_index1', nargs='?', type=int, default=None, help='Only print couplings from this atom.')
parser.add_argument('atom_species2', nargs='?', type=str, default=None,
                    help='Only print couplings to this atomic species.')
...
matching_Js = sorted(matching_Js, key=lambda s1_i1_s2_i2_isc: sorted(
    ((s1_i1_s2_i2_isc[0], s1_i1_s2_i2_isc[1]), (s1_i1_s2_i2_isc[2], s1_i1_s2_i2_isc[3]))))
