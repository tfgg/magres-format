...
setup(name='Magres format',
      ...
      scripts=['scripts/convertoldmagres.py', 'scripts/magresjson.py', 'scripts/extract-all-jc-compare.py', 'scripts/compisc.py', 'scripts/magresmerge.py', 'scripts/extract-all-jc.py', 'scripts/absiscdev.py', 'scripts/nqr.py'],
      )
